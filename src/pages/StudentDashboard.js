          ...
          <div className="lg:col-span-2 bg-[#1e293b] rounded-2xl border border-slate-700/50 p-4 md:p-6">
            ...
            {filteredFiles.length === 0 ? (
              <div className="text-center py-12">
                <FontAwesomeIcon
                  icon={faFile}
                  className="text-slate-600 text-4xl mb-3"
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {filteredFiles.map((file) => (
                  <div
                    key={file._id}
                    className="bg-[#0f172a] rounded-xl border border-slate-700/50 hover:border-indigo-500/40 transition-all duration-200 p-4"
                  >
            ...
            <div className="bg-[#1e293b] rounded-2xl border border-slate-700/50 p-4 md:p-6">
              ...
              {recentSubmissions.length === 0 ? (
                <div className="text-center py-6">
                  <FontAwesomeIcon
                    icon={faClipboard}
                    className="text-slate-600 text-3xl mb-2"
                  />
                  <p className="text-slate-500 text-sm">
                    No submissions yet.
                  </p>
                ...
                <div className="space-y-3">
                  {recentSubmissions.map((sub) => (
                    ...
                    >
                      <div>
                        <p className="text-slate-200 text-sm font-medium truncate max-w-[150px]">
                          {sub.title}
                        </p>
